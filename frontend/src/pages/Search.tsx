        ...
        <div className="h-full overflow-scroll">
          <div className="mt-[5rem]">
            <div className="mb-5 w-[35rem]">
              ...
              {displayedProfiles.length > 0 && <h1 className="text-[25px] font-bold">People</h1>}
              {displayedProfiles.map((profile, index) => (
                <div key={index} className="w-[35rem] justify-between py-3 flex border-b">
            ...
            {posts.length === 0 && <h1 className="text-[25px] font-bold mb-5">Recently Posted</h1>}
            <Posts posts={posts } />
          </div>
        </div>
      </div>
