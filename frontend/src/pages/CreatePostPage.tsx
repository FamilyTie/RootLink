  ...
  const theme = {
    colors: {
      editor: {
        ...
        background: "rgba(243, 244, 246)", // Background matching the input
      },
  ...
  return (
    <div className="bg-[rgb(294, 124, 204)]">
      ...
      <div>
        ...
        >
          <div className=" bg-white w-[35rem] p-5 flex items-start">
            <img
            ...
            <div className="flex flex-col gap-3 w-[30rem] m-2 mt-6">
              <input
                className="bg-gray-100 m-0 rounded-md p-1 placeholder-gray-400"
                placeholder="Title..."
                type="text"
                value={title}
              ...
              <div className="h-[10rem] rounded-md pt-2 bg-gray-100">
              <BlockNoteView
