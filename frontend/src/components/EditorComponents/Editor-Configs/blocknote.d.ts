// Additional type definitions for @blocknote/core
declare module "@blocknote/core" {
  export interface Editor {
    // Add the toJSON method to the Editor interface
    toJSON(): any // Specify the correct return type according to the actual implementation
  }

  // Declare PartialBlock and FilterSuggestion if they are used within the core module
  export type PartialBlock = {
    id?: string
    type: string
    content: array
    // Add other properties that make sense for your PartialBlock
  }

  export type filterSuggestionItems = {
    id: string
    label: string
    value?: any
  ...
  export class BlockNoteEditor {
    ...
    insertBlocks(blocks: PartialBlock[], currentBlock: any, arg2: any): void {
      throw new Error("Method not implemented.")
    }
    static create(options: any): BlockNoteEditor // Adjust according to actual API
    // Add any other members you need to use
  }
}

export const defaultBlockSpecs: { [key: any]: any } // Adjust the type as needed

// Define BlockNoteSchema if it is a class with static methods
export class BlockNoteSchema {
  static create(config: { blockSpecs: any }): any // Define return type and config type as needed
}

// Declarations for @blocknote/mantine that use the extended Editor interface
declare module "@blocknote/mantine" {
  ...
  } from "@blocknote/core" // Import the augmented Editor and new types
  ...
  export class zBlockNoteView extends React.Component<BlockNoteViewProps, {}> {}
}
