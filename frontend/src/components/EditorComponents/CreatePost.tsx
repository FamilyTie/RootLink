...
function CreateAPost({ refetchPosts }) {
    ...
    <div className="bg-[rgb(294, 124, 204)]">
      ...
      <div className="flex bg-white  rounded-md w-[35rem] p-5  items-start">
        <img
          ...
          className="w-12 mr-5 h-12  rounded-full object-cover border-2 border-gray-300 shadow-sm ml-2 mt-4"
          alt=""
        />
        <form onSubmit={handleSubmit}className="flex flex-col gap-0">
          <div className="flex items-start">
            <div className="flex flex-col gap-3 w-[25rem] m-2 mt-6">
              <input
                className="ProseMirror text-[1.3rem] pl-3 w-[20rem]   mb-5 font-medium bg-slate-100  m-0 rounded-md p-1 text-[rgb(157, 173, 184]"
                placeholder="Title..."
                type="text"
                value={title}
              ...
              <button
                className="bg-[#074979] hover:bg-white border-[2px] border-transparent hover:text-[#074979] hover:border-[#074979] transition-all duration-200 self-end text-white text-[1.2rem] p-1 w-[6rem] rounded-sm "
                type="submit"
              >
                Post
              </button>
