...
function MobileNavNotifications({notificationsOpen} : {notificationsOpen: boolean}) {
  ...
  return (
    ...
    <div
    className={`h-screen fixed duration-300 translate-y-[-100vh] overflow-hidden   ${
      notificationsOpen ? " opacity-100" : " opacity-0 pointer-events-none"
    }  w-screen bg-[#074979] border-r border-[#074979]  backdrop-blur-lg bg-opacity-60 `}
  >
    <div className="pt-[5rem]">
      <div className="pb-6 border-b border-[#074a7963]">
        <p className=" text-white text-[2rem]  translate-x-[-8px]  pl-10 font-semibold ">
          Notifications
        </p>
      </div>
...
export default MobileNavNotifications